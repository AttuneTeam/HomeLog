export type Classification = "repair" | "capital_improvement" | "initial_repair"
export type AiTaxClassification = "Immediate Deduction" | "Capital Works (Div 43)" | "Plant & Equipment (Div 40)"
