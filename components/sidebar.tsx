...
import { Building2, LogOut, TrendingUp, Sun, Moon, UserCircle, X, Plug, Mail, Workflow, ChevronDown, Upload, Package } from "lucide-react";
...
const navItems = [
  ...
  { href: "/tax-pack", label: "Tax pack", icon: Package },
